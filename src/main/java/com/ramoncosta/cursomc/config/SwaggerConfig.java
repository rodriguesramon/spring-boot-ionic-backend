...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.select()
				.apis(RequestHandlerSelectors.basePackage("com.ramoncosta.cursomc.resources"))
	...
	private ApiInfo apiInfo() {
		return new ApiInfo("API do Backend Spring Boot",
				"Esta API é utilizada no aplicativo do Ramon Costa",
				"Versão 1.0",
				"https://www.ramoncosta.com/terms",
				new Contact("Ramon Costa", "ramon.com/user/ramon-costa", "ramon.rodrigues.lima@gmail.com"),
				"Permitido uso para estudantes","https://www.ramoncosta.com/terms",
